        ...
        <div class="container-fluid" style="margin-top:120px;">
            <div class="card" style="width:50%; margin:auto; font-size:75%">
                <div class="card-header">
                    <button type="button" class="btn btn-outline-primary col-sm-12" onclick="javascript:printDiv('bill')" style="font-size:135%;">พิมพ์ใบเสร็จ</button>
                    <button type="button" class="btn btn-secondary col-sm-12" onclick="window.location.href='officialBill.php'" style="font-size:135%;">กรอกข้อมูลสำหรับออกบิลเงินสด(เพื่อเบิก)</button>
                </div>
                <div id="bill">
                    <div class="card-body border border-dark">
                        <h1 class="display-4" style="text-align:center;">ร้านแซ่บ</h1>
                        <h5 style="text-align:center;">โทร. 034-837851</h5>
                        <div class="form-inline">
                            <?php   date_default_timezone_set("Asia/Bangkok");  ?>
                            <h4 class="col-sm-6">โต๊ะ <?=$tableNum?></h4>
                            <p class="col-sm-6">เวลา <?=date("H:i")?>น. วันที่ <?=date("d/m/Y",strtotime("+543 Years"))?></p>
                        </div>
                    </div>
